module github.com/michaelhenkel/agent-ng
...
replace (
	...
	github.com/michaelhenkel/config-controller => ../config-controller
	google.golang.org/grpc => google.golang.org/grpc v1.32.0
	ssd-git.juniper.net/contrail/cn2 => ../../../ssd-git.juniper.net/contrail/cn2
)

require (
	github.com/michaelhenkel/config-controller v0.0.0-00010101000000-000000000000
...
require (
	...
	github.com/googleapis/gnostic v0.5.7-v3refs // indirect
